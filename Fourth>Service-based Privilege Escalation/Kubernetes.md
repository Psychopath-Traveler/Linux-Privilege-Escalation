...
1. The Control Plane (master node), which is responsible for controlling the Kubernetes cluster
2. The Worker Nodes (minions), where the containerized applications are run
